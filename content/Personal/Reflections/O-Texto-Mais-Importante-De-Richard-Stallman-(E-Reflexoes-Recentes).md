---
title: O Texto Mais Importante De Richard Stallman (E Reflexões Recentes)
tags:
  - Personal
  - Reflections
draft: false
...
# Contexto inicial
>[!warning]
>Esse é um texto que já nasceu póstumo.

Como ficou claro pelos meus dois textos anteriores, [Inicio Do Hardening - Root criptografado](IT/Security/Defensive/Personal-Security/Linux-Hardening/Gentoo-Hardening/Inicio-Do-Hardening-Root-criptografado.md) e [Minha Primeira Experiencia Com Borg Backup](IT/Home-Lab/Data-Hoarder/Minha-Primeira-Experiencia-Com-Borg-Backup.md), eu tenho uma **genuína** admiração pelo movimento *Cypherpunk*. Naturalmente, não poderia ser diferente com o movimento de software livre, que foi fundado e é até hoje impulsionado principalmente pela *Free Software Foundation* (FSF), sendo seu maior expoente o estadunidense **Richard Matthew Stallman** (RMS).

Para aqueles que desejam se aprofundar nas questões referentes ao projeto *GNU* e as questões relacionadas a licenciamento de software, eu recomendo a leitura do livro [Free Software, Free Society](https://www.gnu.org/doc/fsfs3-hardcover.pdf), que é um coletanea de ensaios do próprio Stallman. E, por fim, para aqueles que desejam se aprofundar na biografia e no trabalho do Stallman, recomendo livro [Free as in Freedom - Richard Stallman’s Crusade for Free Software](https://static.fsf.org/nosvn/faif-2.0.pdf)
...
>[!warning]
>Spoilers de Admirável Mundo Novo abaixo
...
1. Os eventos descritos no texto *já* aconteceram, ainda que em menor grau. 
...
Dedico a seguinte seção para enumerar alguns eventos relativamente recentes para corroborar com a tese anteriormente exposta, citando o rumo recente de outras tecnologias de controle pelo Estado, dessa vez sobre o ar(j)gumento de ["Pense nas crianças!"](https://en.wikipedia.org/wiki/Think_of_the_children).
...
Para todos aqueles que querem um aprofundamento sobre como o *Estado* se porta como benfeitor para expandir o seu poder, recomendo uma pesquisa sobre o que foram as *[Crypto Wars](https://pt.wikipedia.org/wiki/Crypto_Wars)*. E, por fim, a leitura de "*[Porque eu escrevi o PGP](https://nakamotoinstitute.org/pt-br/library/porque-eu-escrevi-o-pgp/)*", de Philip R. Zimmermann.
...
3. Complexidade técnica: Por mais que existissem na época ferramentas como o [wordpress](https://wordpress.com/) e *blogger* (da Google), elas poderiam ser vistas para usuário leigo como excessivamente complexas e, para os mais experientes, como limitantes.
...
- [Right to Read](https://www.gnu.org/philosophy/right-to-read.pt-br.html)
- [Definição de *Realpolitik* usada](https://spreadgreatideas.org/glossary/realpolitik/)
...
- [Texto da "*Lei Felca*"](https://www.vademecumprevidenciario.com.br/legislacao/htm/lei_00152112025)